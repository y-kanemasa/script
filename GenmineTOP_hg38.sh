...
cat ../database/vcf_head3.tsv Book7.tsv > shortVariants.vcf
...
join -t "," --header -a 1 -1 4 -2 1 -e "." -o auto <(head -n +1 annotation.snpeff.sort.annotate3.csv && tail -n +2 annotation.snpeff.sort.annotate3.csv | sort -k 4,4 -t ',') /mnt/c/Users/Yusuke\ Kanemasa/Desktop/EPdata/database/cancerGeneList3.csv > annotation.snpeff.sort.annotate4.csv
