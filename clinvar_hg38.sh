...
old_files=(clinvar_[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9].hg38.recode2.vcf.gz)
...
if ((${#files[@]} == 1)); then
  ...
  rm ../database/$filename_base.vcf.gz ../database/$filename_base.hg38.recode.vcf ../database/$filename_base.hg38.log ../database/$old_files ../database/$old_files.tbi
